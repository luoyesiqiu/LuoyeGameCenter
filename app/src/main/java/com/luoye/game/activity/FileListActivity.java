...
import com.luoye.game.adapter.FileListAdapter;
import com.luoye.game.entity.FileListItem;
import com.luoye.game.util.ConstantPool;
import com.luoye.game.util.FileNameSort;
...
public class FileListActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        {
            curpath = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "LuoyeGame");
            if(!curpath.exists())
            {
                curpath.mkdirs();
            }
    ...
    private void loadList(File path) {
        File[] files = path.listFiles(new NesFileFilter(false));
