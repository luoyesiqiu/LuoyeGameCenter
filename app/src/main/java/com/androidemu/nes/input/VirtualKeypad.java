...
import com.androidemu.nes.wrapper.*;
...
public class VirtualKeypad {
	...
	public VirtualKeypad(View v, GameKeyListener l) {
		...
		dpad = createControl(R.mipmap.dpad);
		buttons = createControl(R.mipmap.buttons);
		extraButtons = createControl(R.mipmap.extra_buttons);
		selectStart = createControl(R.mipmap.select_start_buttons);
	}
